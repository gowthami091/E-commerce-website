...
urlpatterns = [
	...
	path("profile/order-<int:pk>/cancel-order/", CustomerOrderCancelView, name="customerordercancel"),
	path("profile/order-cancel-success/",CustomerOrderCancelSucessView, name="customerordercancelsuccess" ),
